...
export function BriefResponsesView({ briefId, open, onOpenChange }: BriefResponsesViewProps) {
  ...
  const generateSummary = () => {
    ...
    // This is a placeholder for AI-generated summary
    // In a real implementation, you would send the conversations to an AI service
            ...
            <TabsContent value="responses" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Individual team member responses and chat transcripts
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
